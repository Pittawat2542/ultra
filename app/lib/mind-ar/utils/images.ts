...
type UpSampleParams = {
  image: Image,
  padOneWidth: boolean;
  padOneHeight: boolean;
}

type DownSampleParams = { image: Image }

type ResizeParams = { image: Image, ratio: number }

export const _upSampleBilinear = ({ image, padOneWidth, padOneHeight }: UpSampleParams) => {
...
export const upSampleBilinear = ({ image, padOneWidth, padOneHeight }: UpSampleParams) => {
  const { width, height, data } = image;
...
export const downSampleBilinear = ({ image }: DownSampleParams) => {
...
export const resize = ({ image, ratio }: ResizeParams) => {
